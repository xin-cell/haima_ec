...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="media/images/", width=1000, height=300,
                              filePath="media/files/", default='')
    ship_free = models.BooleanField("是否承担运费",default=True)
    # 首页中展示的商品封面图
    goods_front_image = models.ImageField(upload_to="media/images/", null=True, blank=True, verbose_name="封面图")
    # 首页中新品展示
